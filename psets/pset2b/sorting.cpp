...
Signed: shinhookim Class number: ECE20010-03 Student Number: 21900136
*/
...
int main(int argc, char *argv[]) {
	...
	cout << "your code here\n"; 		// define sort_map
	map<void (*)(int *list, int n, bool (*comp)(int, int)), string> sort_map;
	...
	do {
		...
		stringstream ss;
		ss << "\tMENU[ sort=" << comp_map[comp_fp] << " order=" << sort_map[sort_fp];
